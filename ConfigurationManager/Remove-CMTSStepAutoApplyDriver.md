...
Specify a task sequence object from which to remove the Auto Apply Drivers step. To get this object, use the Get-CMTaskSequence (Get-CMTaskSequence.md)cmdlet.
...
### Syntax
```PowerShell
Remove-CMTSStepAutoApplyDriver [-InputObject] <IResultObject> [-Force] [-StepName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
```PowerShell
Remove-CMTSStepAutoApplyDriver [-TaskSequenceId] <String> [-Force] [-StepName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
```PowerShell
Remove-CMTSStepAutoApplyDriver [-TaskSequenceName] <String> [-Force] [-StepName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
