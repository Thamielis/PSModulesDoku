...
### Syntax
```PowerShell
Set-CMComplianceRuleValue [-DisableWildcardHandling] [-ExpectedValue <String[]>] [-ExpressionOperator {IsEquals | NotEquals | BeginsWith | NotBeginsWith | EndsWith | NotEndsWith | Contains | NotContains | OneOf | NoneOf}] [-ForceWildcardHandling] -InputObject <IResultObject> [-NewRuleName <String>] [-NoncomplianceSeverity {None | Informational | Warning | Critical | CriticalWithEvent}] [-PassThru] [-Remediate <Boolean>] [-ReportNoncompliance <Boolean>] [-RuleDescription <String>] -RuleName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```
```PowerShell
Set-CMComplianceRuleValue [-DisableWildcardHandling] [-ExpectedValue <String[]>] [-ExpressionOperator {IsEquals | NotEquals | BeginsWith | NotBeginsWith | EndsWith | NotEndsWith | Contains | NotContains | OneOf | NoneOf}] [-ForceWildcardHandling] [-NewRuleName <String>] [-NoncomplianceSeverity {None | Informational | Warning | Critical | CriticalWithEvent}] [-PassThru] [-Remediate <Boolean>] [-ReportNoncompliance <Boolean>] -Rule <Rule> [-RuleDescription <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
