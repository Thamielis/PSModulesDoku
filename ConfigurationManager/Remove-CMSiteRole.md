...
### Syntax
```PowerShell
Remove-CMSiteRole [-DisableWildcardHandling] [-Force] [-ForceWildcardHandling] -InputObject <IResultObject> [-Confirm] [-WhatIf] [<CommonParameters>]
```
```PowerShell
Remove-CMSiteRole [-DisableWildcardHandling] [-Force] [-ForceWildcardHandling] -RoleName <String> [-SiteCode <String>] -SiteSystemServerName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```
