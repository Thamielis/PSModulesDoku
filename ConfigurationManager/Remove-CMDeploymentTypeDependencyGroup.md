...
### Syntax
```PowerShell
Remove-CMDeploymentTypeDependencyGroup [-DisableWildcardHandling] [-Force] [-ForceWildcardHandling] -InputObject <DeploymentTypeDependencyGroup> [-Confirm] [-WhatIf] [<CommonParameters>]
```
