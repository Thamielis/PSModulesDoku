...
Use this cmdlet to get a registry setting condition object from a task sequence step. You can use this object to:
...
### Related Links
* [New-CMTSStepConditionRegistry](New-CMTSStepConditionRegistry)
...
### Examples
#### Example 1: View the details of a registry condition
```PowerShell
...
Specify a task sequence step object with a registry condition. To get this object, use one of the Get-CMTSStep cmdlets. For example, Get-CMTSStepApplyDataImage (Get-CMTSStepApplyDataImage.md).
...
### Syntax
```PowerShell
Get-CMTSStepConditionRegistry [-DisableWildcardHandling] [-ForceWildcardHandling] -InputObject <IResultObject> [<CommonParameters>]
```
